/**
 * @license
 * Based in Selectivity.js 3.1.0 <https://arendjr.github.io/selectivity/>
 * Copyright (c) 2014-2016 Arend van Beelen jr.
 *           (c) 2016 Speakap BV
 * License <https://github.com/arendjr/selectivity/blob/master/LICENSE>
 */
(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.selectivity = f() } })(function () {
        ...
        1: [function (_dereq_, module, exports) {
            ...
            function createSelectivityNextToSelectElement($el, options) {
                ...
                if (options.multiple == true) {
                    classes.push('wrap-selectivity-multiple-input');
                }
